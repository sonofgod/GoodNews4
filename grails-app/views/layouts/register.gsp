...
<link rel="shortcut icon" href="${resource(dir:'images',file:'favicon.ico')}" type="image/x-icon"/>
	...
	<link rel="stylesheet" media="screen" href="${resource(dir:'css',file:'font-awesome.css',plugin:'spring-security-ui')}"/>
...
<%--	<link rel="stylesheet" media="screen" href="${resource(dir:'css',file:'spring-security-ui.css',plugin:'spring-security-ui')}"/>--%>
	<link rel="stylesheet" media="screen" href="${resource(dir:'css',file:'spring-security-ui-ta.css',plugin:'spring-security-ui')}"/>
	<jqui:resources />
	...
	<link rel="stylesheet" media="screen" href="${resource(dir:'css',file:'jquery-custom-ui-ta.css')}"/>
